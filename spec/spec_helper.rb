...
def dudes_konto
  opts = { :nr => '7828970037', :blz => '37040044', :account_name =>'Gimme your Money AG',
            :bank_name => 'Commerzbank Köln', :zweck => 'Monatsbeitrag', :street => "5th avenue", :city => "los angeles", :zip_code => "55323", :client_number => "" }
  TestKonto.new(opts)
end

def test_kto1
  opts = { :nr => '7828970037', :blz => '37040044', :name =>'Gimme your Money AG',
            :bank => 'Commerzbank Köln', :zweck => 'Monatsbeitrag', :client_number => "" }
  TestKonto.new(opts)
end
