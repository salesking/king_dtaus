...
describe KingDta::SumupDtaus do
  ...
  it "should create a C block that contains 2 booking texts" do
    ...
    @sumup_dtaus.bookings.first.text = {pid: 'SalesKing Monatsbeitrag ',email:'08/10 Freelancer Version', mid: '1234'}
    ...
    out =  "0216C00000000370400440002787777000000000000051000 0000000000037040044782897003700000022025   PETER & MAY GMBH                   GIMME YOUR MONEY AG        SalesKing Monatsbeitrag    1  010208/10 Freelancer Version     1234                                  "
    str.should == out
  end
  ...
  it "should create c-sektion with long account owner name in extension" do
    ...
    str.length.should == 256
    str.should include(@kto2.owner_name.upcase)
    out = "0216C00000000370400440002787777000000000000051000 0000000000037040044782897003700000022025   PETER & MAY GMBH                   A VERY LONG NAME EXEEDING 2SalesKing Monatsbeitrag    1  010208/10 Freelancer Version     1234                                  "
    str.should == out
  end
